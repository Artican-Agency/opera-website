...
function HeroSection() {
  return (
    <div className="flex flex-col justify-start items-start">
      <h1 className="md:text-5xl text-4xl font-bold flex flex-col justify-start items-center font-sans">
        Exprimez votre style avec{" "}
      </h1>
      <h2 className="flex justify-center items-center md:text-5xl text-4xl font-bold font-sans relative bottom-6">
        <Image
          src={Logo}
          height={191}
          width={150}
